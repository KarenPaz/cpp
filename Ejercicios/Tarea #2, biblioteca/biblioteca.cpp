    ...
    while (salir == false)
    {
        ...
        for (int i = 0; i < 25; i++)
        {
            ...
            if (libroEnminuscula.find(buscar) != string::npos || autorEnminuscula.find(buscar) != string::npos) {
                ...
                cout << " Sugerencia 1: " << libros[sugerencia1][1] << ", Autor: " << libros[sugerencia1][2] <<endl;
                cout << " Sugerencia 2: " << libros[sugerencia2][1] << ", Autor: "<< libros[sugerencia2][2]<< endl;
                cout << " Sugerencia 3: " << libros[sugerencia3][1] << ", Autor: "<< libros[sugerencia3][2]<< endl;
